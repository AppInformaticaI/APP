...
<body x-data="{ mobileOpen: false }" class="bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-gray-200">
  ...
  <header id="site-header"
          class="
            fixed w-full top-6 md:top-6 z-40 py-4
...
<div class="flex items-center space-x-4">
  ...
  <button id="dark-toggle" class="p-2 bg-white dark:bg-gray-800 rounded-full shadow-md transition">
    ...
    <!-- Navegación escritorio: software + dropdown “Otros” -->
      ...
      <ul id="software-links" class="flex space-x-6 text-gray-800 dark:text-gray-200">
        <?php
          $links = [
            ...
            '/software/office'    => 'Office',
            '/software/antivirus' => 'Antivirus',
            '/juegos'             => 'Juegos',
            '/software/autodesk'  => 'Autodesk',
            '/software/canvas'    => 'Canvas Pro',
            '/software/adobe-cc'  => 'Adobe CC',
            '/software/vpn'       => 'VPN',
            '/noticias/vpn'       => 'Noticias',
          ];
          foreach($links as $path => $label):
            $active = ($current === $path) ? 'border-b-2 border-accent' : '';
        ?>
          <li>
            <a href="<?= $path ?>"
               class="px-2 py-1 hover:text-accent transition <?= $active ?>">
              <?= $label ?>
            </a>
          </li>
        <?php endforeach; ?>
      ...
      <nav>
        <ul class="space-y-3 text-gray-800 dark:text-gray-200">
          <?php foreach($links as $path => $label): ?>
            <li><a href="<?= $path ?>" class="block hover:text-accent"><?= $label ?></a></li>
          <?php endforeach; ?>
  ...
  >
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full text-center space-y-4 max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <p class="text-base sm:text-lg lg:text-2xl text-gray-200 max-w-2xl">
        Soluciones en Bolivia: licencias oficiales y software con garantia, <strong>facturadas</strong>, entrega instantánea ,atencion y soporte 24/7.
      </p>
      ...
      <div class="flex flex-wrap justify-center gap-4">
        <a href="#productos-destacados" class="px-8 py-3 bg-primary hover:bg-primary/90 text-white rounded-full font-semibold text-lg transition focus:outline-none focus:ring-2 focus:ring-primary">Ver Ofertas</a>
        <a href="#contacto" class="px-8 py-3 bg-white/80 hover:bg-white text-gray-900 rounded-full font-semibold text-lg transition focus:outline-none focus:ring-2 focus:ring-accent">Contáctanos</a>
      </div>
  ...
  <!-- BENEFICIOS -->
  <section id="beneficios" aria-label="Nuestros beneficios" class="py-12 mb-8 bg-gradient-to-tr from-primary/5 to-transparent dark:from-accent/10 dark:to-transparent">
...
<section id="ofertas-flash"
  ...
  <div class="max-w-7xl mx-auto px-6">
    ...
    <div class="flex flex-col lg:flex-row items-start gap-6">
      ...
      <div x-data="countdownComponent" x-init="init()"
        ...
        <!-- Título con degradado + destellos -->
  ...
  <span class="sparkle-dot"></span>
      ...
      <!-- PRODUCTOS FLASH -->
 <?php
  // URL base para imágenes locales (si usas nombres de archivo)
  $baseImgUrl = 'http://localhost/app/images/artbox/';

  // Lista de productos Flash; img puede ser URL absoluta o nombre de archivo
  $flashProducts = [
    [
      'img' => 'http://localhost/App/img/3.png',
    ...
    [
      'img' => 'http://localhost/App/img/4.png',
      'title'    => 'Office 365',
      'price'    => '$59.99',
      'original' => '$89.99',
      'discount' => 33
    ...
    [
       'img' => 'http://localhost/App/img/5.png',
      'title'    => 'Windows 11',
      'price'    => '$69.99',
      'original' => '$99.99',
      'discount' => 30
    ...
    [
      'img'      => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDmh0Z8qiQCX1GYuDcNCBAQEUFd02KYP6jXQ&s',
      'title'    => 'Office 2019',
      'price'    => '$79.99',
      'original' => '$119.99',
      'discount' => 33
...
<div class="w-full lg:w-3/4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
  <?php foreach($flashProducts as $p): 
    // Si img arranca con http o https, úsala tal cual; si no, préndele la base
    $src = preg_match('/^https?:\/\//', $p['img'])
           ? $p['img']
           : $baseImgUrl . $p['img'];
  ?>
    <div class="relative bg-white dark:bg-gray-700 rounded-lg shadow-md p-4 flex flex-col items-center text-center">
      ...
      <!-- Imagen (h-40 para mantener altura uniforme) -->
      ...
      <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-1"><?= $p['title'] ?></h3>
      <div class="flex items-center mb-1">
        <span class="text-yellow-400">★★★★☆</span>
        <span class="text-xs text-gray-600 dark:text-gray-300 ml-2">(4.0)</span>
      </div>
      <p class="text-gray-500 dark:text-gray-400 line-through text-sm"><?= $p['original'] ?></p>
      <p class="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4"><?= $p['price'] ?></p>
      <a href="#"
  ...
  <section id="productos-destacados" aria-label="Productos destacados" class="py-12 mb-8 bg-gradient-to-br from-gray-50 to-transparent dark:from-gray-800 dark:to-transparent">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
        <?php
          $products = [
            ['img'=>'Windows+10+Pro','title'=>'Windows 10 Pro','price'=>'$199.99'],
            ['img'=>'Office+365','title'=>'Office 365','price'=>'$99.99'],
            ['img'=>'Kaspersky+Antivirus','title'=>'Kaspersky Antivirus','price'=>'$49.99'],
            ['img'=>'Adobe+CC','title'=>'Adobe CC','price'=>'$239.99'],
            ['img'=>'Adobe+CC','title'=>'Adobe CC','price'=>'$239.99'],
            ['img'=>'AutoCAD+2024','title'=>'AutoCAD 2024','price'=>'$180.00'],
            ['img'=>'AutoCAD+2024','title'=>'AutoCAD 2024','price'=>'$180.00'],
          ];
        ...
        ?>
          <div class="tilt bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 flex flex-col justify-between h-full transition-transform hover:scale-[1.02]"
               data-tilt data-aos="fade-up" data-aos-delay="<?= $i*100 ?>">
            <img src="https://via.placeholder.com/300x200?text=<?= $p['img'] ?>"
                 alt="<?= $p['title'] ?>" loading="lazy"
                 class="h-40 w-full object-cover rounded-md mb-4"/>
            <h3 class="text-lg font-semibold mb-1 text-gray-800 dark:text-gray-100"><?= $p['title'] ?></h3>
            <p class="text-gray-600 dark:text-gray-400 mb-4"><?= $p['price'] ?></p>
...
<script>
  document.addEventListener('alpine:init', () => {
    Alpine.data('countdownComponent', () => ({
      ...
      // Ajusta tu fecha límite de oferta aquí:
